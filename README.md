...
Stack Design: Svelte-Kit & Supabase

Default (GPT-3.5)

User
Write all the paragraphs of the last section named "Behind the design", this is a readme on a repo on github so it has to be kind of technical but not overwhelming: <p align="center"> 
     <img src="https://svgshare.com/i/vcw.svg" height="250"/> 
     </br> </br> 
     A fullstack starter kit heavily inspired by <a href="https://create.t3.gg/">create-t3-app</a> with variuos added bonuses 
     </br> </br> 
